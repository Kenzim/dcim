<script>
  ...
  $: isBareMetalCatalogActive = currentPath.startsWith('/admin/bare-metal-catalog');
  ...
  $: isStoreCategoriesActive = currentPath.startsWith('/admin/store/categories');
  $: isStoreProductsActive = currentPath.startsWith('/admin/store/products');
  $: isStoreCouponsActive = currentPath.startsWith('/admin/store/coupons');
  $: isCommerceOrdersActive = currentPath.startsWith('/admin/commerce/orders');
  $: isCommerceInvoicesActive = currentPath.startsWith('/admin/commerce/invoices');
  $: isCommerceTransactionsActive = currentPath.startsWith('/admin/commerce/transactions');
  $: isCommerceGatewayLogsActive = currentPath.startsWith('/admin/commerce/gateway-logs');
  $: isCommerceEmailLogActive = currentPath.startsWith('/admin/commerce/email-log');
  $: isCommerceAuditActive = currentPath.startsWith('/admin/commerce/audit');
  $: isSupportTicketsActive = currentPath.startsWith('/admin/support/tickets');
</script>
...
<nav class="sidebar" class:open={$sidebarOpen}>
  ...
  <div class="sidebar-nav">
    ...
    <div class="nav-group">
      ...
      <ul class="nav-list">
        <li class="nav-item">
          <a href="/admin/bare-metal-catalog" class="nav-link" class:active={isBareMetalCatalogActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
            </svg>
            <span>Bare Metal Catalog</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <div class="nav-group">
      ...
      <ul class="nav-list">
        <li class="nav-item">
          <a href="/admin/store/categories" class="nav-link" class:active={isStoreCategoriesActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="nav-item">
          <a href="/admin/store/products" class="nav-link" class:active={isStoreProductsActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="nav-item">
          <a href="/admin/store/coupons" class="nav-link" class:active={isStoreCouponsActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="nav-group">
      ...
      <ul class="nav-list">
        ...
        <li class="nav-item">
          <a href="/admin/commerce/orders" class="nav-link" class:active={isCommerceOrdersActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="nav-item">
          <a href="/admin/commerce/invoices" class="nav-link" class:active={isCommerceInvoicesActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <span>Invoices</span>
        ...
        <li class="nav-item">
          <a href="/admin/commerce/transactions" class="nav-link" class:active={isCommerceTransactionsActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="nav-item">
          <a href="/admin/commerce/gateway-logs" class="nav-link" class:active={isCommerceGatewayLogsActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="nav-item">
          <a href="/admin/commerce/email-log" class="nav-link" class:active={isCommerceEmailLogActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="nav-group">
      ...
      <ul class="nav-list">
        <li class="nav-item">
          <a href="/admin/support/tickets" class="nav-link" class:active={isSupportTicketsActive}>
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
